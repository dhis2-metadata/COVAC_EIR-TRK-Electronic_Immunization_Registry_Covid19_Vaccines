...
### Step 1.1 - Open the "Tracker Capture" app
...
### Step 4.1 - Click on ‘Save and continue’ to proceed to the ‘Data Entry’ section

![Save and continue](resources/images/save_and_continue_en.png)

## 2 - Data Entry – Vaccination (1^st^ dose)

### Step 2.1 - Scroll down to the data entry widget and select a date in which the 1st dose was given on

![Event date](resources/images/event_date_en.png)

### Step 2.2 - Fill in the details for Underlying Conditions, Pre-Immunization and Vaccination Information
...
### Step 3.1 - After completing the details on the 1st dose and having selected the “Complete” button, schedule the next vaccination
...
### Step 3.2 - Modify the date if needed
...
### Step 3.3 - The new event will show, with the due date being the date you have scheduled for the next dose

![Due date](resources/images/due_date_en.png)

## 4 - Searching for a case

### Step 4.1 - Open the "Tracker Capture" app
...
### Step 4.4 - Select your case from the results pop-up to be taken to their dashboard

![Slect case](resources/images/select_case_en.png)

## 5 - Using the front page list filters

### Step 5.1 - Open the “Tracker Capture” app
...
### Step 5.3 - Select your person from the front page list to be taken to their dashboard

![Select person](resources/images/select_tei_en.png)

## 6 - Data Entry – Vaccination (2^nd^ dose)

### Step 6.1 - With the 2^nd^ Vaccination stage open, select a date of the event to begin data entry
...
### Step 6.2 - Fill in the details for Underlying Conditions, Pre-Immunization and Vaccination Information
...
### Step 7.1 - Scroll to the top of the cases dashboard until you see the Enrollment section
...
### Step 7.2 - Complete the enrollment
...
### Step 8.2 - Select “reports” from the left side menu

![Reports](resources/images/reports_en.png)

### Step 8.3 - Select "Upcoming Events"

![Upcoming events](resources/images/upcoming_events_en.png)

### Step 8.4 - Specify the inputs of the report
...
### Step 8.5 - Run the report and view the results
...
### Step 9.1 - Open the “Tracker Capture” app
...
### Step 9.2 - Select “Reports” from the left side menu

![Reports](resources/images/reports_en.png)

### Step 9.3 - Select “Overdue Events”

![Overdue events](resources/images/overdue_events_en.png)

### Step 9.4 - Specify the inputs of the report
...
### Step 9.5 - The report will run once you select your inputs

![Overdue report](resources/images/overdue_report_en.png)

## 10 - Editing Data

### Profile - To edit a person’s profile, do this from the “Profile” box in their tracker overview page

![Profile edit](resources/images/profile_edit_en.png)

1. Select the "Edit" buttom
2. Edit the details
3. Select "Save" to save the changes"

### Data - To change data, select the field you want to update and make your changes

![Data edit](resources/images/data_edit_en.png)
